...
import ChangeChatName from "../features/settings/ChangeChatName"
import AppIcon from "../features/settings/AppIcon"
  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<BaseLayout />}>
        ...
        <Route path="change-chat-name" element={<ChangeChatName />}/>
